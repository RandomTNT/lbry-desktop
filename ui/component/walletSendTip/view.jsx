...
function WalletSendTip(props: Props) {
  ...
  const isBoost = claimIsMine || !sendAsTip;
  ...
  function sendSupportOrConfirm(instantTipMaxAmount = null) {
    ...
    if (!isBoost && !isConfirming && (!instantTipMaxAmount || !instantTipEnabled || tipAmount > instantTipMaxAmount)) {
      ...
      sendSupport(supportParams, isBoost);
      closeModal();
    }
  }
            ...
            isConfirming ? (
              <>
                <div className="section section--padded card--inline confirm__wrapper">
                  <div className="section">
                    ...
                    <div className="confirm__label">{__(isBoost ? 'Boosting' : 'Tipping')}</div>
                    <div className="confirm__value">
              ...
              <>
                ...
                <div className="section__actions">
                  <Button
                    autoFocus
                    icon={isBoost ? ICONS.TRENDING : ICONS.SUPPORT}
                    button="primary"
                    type="submit"
